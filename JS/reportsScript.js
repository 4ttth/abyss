...
// Form validation
document.querySelector('form').addEventListener('submit', function(e) {
    const category = document.querySelector('[name="report_category"]');
    const details = document.querySelector('[name="report_details"]');
    
    if (category.value === '' || details.value.trim() === '') {
        e.preventDefault();
