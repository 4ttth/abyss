...
<script>
  ...
  gtag('config', 'G-5PJVHXE14X');
    ...
    <title>ABYSS — Verification Requests</title>
    <link rel="stylesheet" type="text/css" href="CSS/modRequestsStyle.css">
...
<body>
        ...
        <div class="container-fluid navigationBar vertical-nav">
            ...
            <div class="navBarOverflow">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../Moderator Functions/modRequests.php">
    ...
    <script src="JS/modRequestsScript.js"></script>
