...
$sql = "SELECT
            ...
            Challenger_Squad_ID,
            Squad_ID,
            CONCAT(Scrim_Date, ' ', Scrim_Time) as Match_Time,
            Status
        FROM tbl_inviteslog";
...
<head>
    ...
    <title>ABYSS — Invites Log</title>
    <link rel="stylesheet" type="text/css" href="CSS/modInvitesLogStyle.css">
...
<body>
    ...
    <div class="pageContent hiddenContent">
        ...
        <div class="container-fluid navigationBar vertical-nav">
            ...
            <div class="navBarOverflow">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../Moderator Functions/modInvitesLog.php">
        ...
        <div class="container-fluid row mainBody">
            <table id="invitesTable" class="display">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Challenger</th>
    ...
    <script src="JS/modInvitesLogScript.js"></script>
