...
$queries = [
    ...
    'Reports (Pending)' => "SELECT COUNT(*) AS count FROM tbl_reports WHERE Report_Status = 'Pending'",
    'Reports (Action Taken)' => "SELECT COUNT(*) AS count FROM tbl_reports WHERE Report_Status = 'Action Taken'",
    ...
    'Squad Posts (Public)' => "SELECT COUNT(*) AS count FROM tbl_squadposts WHERE Post_Type = 'Public'",
    'Squad Posts (Private)' => "SELECT COUNT(*) AS count FROM tbl_squadposts WHERE Post_Type = 'Private'",
    'Squad Posts (Total)' => "SELECT COUNT(*) AS count FROM tbl_squadposts",
    'Squads (Amateur)' => "SELECT COUNT(*) AS count FROM tbl_squadprofile WHERE Squad_Level = 'Amateur'",
    'Squads (Professional)' => "SELECT COUNT(*) AS count FROM tbl_squadprofile WHERE Squad_Level = 'Professional'",
    'Squads (Collegiate)' => "SELECT COUNT(*) AS count FROM tbl_squadprofile WHERE Squad_Level = 'Collegiate'",
